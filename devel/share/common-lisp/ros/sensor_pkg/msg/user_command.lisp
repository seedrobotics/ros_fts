...
(cl:defclass <user_command> (roslisp-msg-protocol:ros-message)
  ((calibrate
    :reader calibrate
    :initarg :calibrate
    :type cl:boolean
...
(cl:defclass user_command (<user_command>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <user_command>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'user_command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_pkg-msg:<user_command> is deprecated: use sensor_pkg-msg:user_command instead.")))

(cl:ensure-generic-function 'calibrate-val :lambda-list '(m))
(cl:defmethod calibrate-val ((m <user_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_pkg-msg:calibrate-val is deprecated.  Use sensor_pkg-msg:calibrate instead.")
  (calibrate m))

(cl:ensure-generic-function 'setepoch-val :lambda-list '(m))
(cl:defmethod setepoch-val ((m <user_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_pkg-msg:setepoch-val is deprecated.  Use sensor_pkg-msg:setepoch instead.")
  (setepoch m))

(cl:ensure-generic-function 'epoch_sec-val :lambda-list '(m))
(cl:defmethod epoch_sec-val ((m <user_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_pkg-msg:epoch_sec-val is deprecated.  Use sensor_pkg-msg:epoch_sec instead.")
  (epoch_sec m))

(cl:ensure-generic-function 'epoch_msec-val :lambda-list '(m))
(cl:defmethod epoch_msec-val ((m <user_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_pkg-msg:epoch_msec-val is deprecated.  Use sensor_pkg-msg:epoch_msec instead.")
  (epoch_msec m))

(cl:ensure-generic-function 'diagnosis_request-val :lambda-list '(m))
(cl:defmethod diagnosis_request-val ((m <user_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_pkg-msg:diagnosis_request-val is deprecated.  Use sensor_pkg-msg:diagnosis_request instead.")
  (diagnosis_request m))

(cl:ensure-generic-function 'set_frequency-val :lambda-list '(m))
(cl:defmethod set_frequency-val ((m <user_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_pkg-msg:set_frequency-val is deprecated.  Use sensor_pkg-msg:set_frequency instead.")
  (set_frequency m))

(cl:ensure-generic-function 'frequency-val :lambda-list '(m))
(cl:defmethod frequency-val ((m <user_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_pkg-msg:frequency-val is deprecated.  Use sensor_pkg-msg:frequency instead.")
  (frequency m))

(cl:ensure-generic-function 'raw_string-val :lambda-list '(m))
(cl:defmethod raw_string-val ((m <user_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_pkg-msg:raw_string-val is deprecated.  Use sensor_pkg-msg:raw_string instead.")
  (raw_string m))

(cl:ensure-generic-function 'raw-val :lambda-list '(m))
(cl:defmethod raw-val ((m <user_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_pkg-msg:raw-val is deprecated.  Use sensor_pkg-msg:raw instead.")
  (raw m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <user_command>) ostream)
  "Serializes a message object of type '<user_command>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <user_command>) istream)
  "Deserializes a message object of type '<user_command>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<user_command>)))
  "Returns string type for a message object of type '<user_command>"
  "sensor_pkg/user_command")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'user_command)))
  "Returns string type for a message object of type 'user_command"
  "sensor_pkg/user_command")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<user_command>)))
  "Returns md5sum for a message object of type '<user_command>"
  "07453c0ab726c6f2c228b4f0e11711ec")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'user_command)))
  "Returns md5sum for a message object of type 'user_command"
  "07453c0ab726c6f2c228b4f0e11711ec")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<user_command>)))
  "Returns full string definition for message of type '<user_command>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'user_command)))
  "Returns full string definition for message of type 'user_command"
  (cl:format cl:nil "bool calibrate~%bool setepoch~%string epoch_sec~%string epoch_msec~%bool diagnosis_request~%bool set_frequency~%int8 frequency~%bool raw_string~%string raw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <user_command>))
  (cl:+ 0
     1
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <user_command>))
  "Converts a ROS message object to a list"
  (cl:list 'user_command
